...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		Company cp = dm.deserialiseObject();
		System.out.println(cp.toString());
		System.out.println("///////");
		System.out.println(cp.getDepartment_List());
		...
		Worker wTest;
		try {
			System.out.println("--Test:getDepartmentByName: Jungle ");
			dpTest = cp.getDepartmentByName("Jungle");
			System.out.println(dpTest.toString());
			System.out.println("--Test:getDepartmentById: 2 ");
			dpTest = cp.getDepartmentById(2);
			System.out.println(dpTest.toString());
			System.out.println("/////////////////////////////////////");
			System.out.println("--getWorkerById: 12347 Adrien ");

			wTest = dpTest.getWorkerById(12347);
		...
		try {
			mid.deleteWorker(mid.getWorkerById(12347));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		try {
			System.out.println(mid.getWorkerById(12347).toString());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
